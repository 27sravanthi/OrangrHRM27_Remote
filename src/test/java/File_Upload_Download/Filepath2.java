...
public class Filepath2 {
  ...
  public void File_Upload() throws Exception {
		...
		driver.get("https://opensource-demo.orangehrmlive.com/");	
	     ...
	     findElement(By.id("jobTitle_jobTitle")).sendKeys("Java2");
	     findElement(By.id("jobTitle_jobDescription")).sendKeys("Java Discription2");
  ...
  public void FileUpload(String PhotoPath) throws Exception {
	...
	// Release CTRL+V
	 ...
	 Thread.sleep(8000);
      ...
      findElement(By.id("jobTitle_note")).sendKeys("Java Note2");
